...
Begin VB.Form frmSrchExpiry 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Search Product by Expiry Date"
   ClientHeight    =   3690
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4680
   Icon            =   "frmSrchExpiry.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3690
   ...
   Begin prjChameleon.chameleonButton cmdClose 
      ...
      FCOLO           =   0
      MPTR            =   0
      MICON           =   "frmSrchExpiry.frx":0EE6
   End
   Begin VB.Frame Frame1 
      Caption         =   "Enter Latest Expiry Date"
      Height          =   1575
      Left            =   120
      TabIndex        =   1
      Top             =   120
   ...
   End
End
Attribute VB_Name = "frmSrchExpiry"
