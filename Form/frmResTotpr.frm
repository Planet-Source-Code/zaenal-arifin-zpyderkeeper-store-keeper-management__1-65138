...
Begin VB.Form frmResTotpr 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Results of Search by Total Price"
   ClientHeight    =   4575
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5805
   Icon            =   "frmResTotpr.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
...
If (frmSrchTotpr.txtTotpr <> "") Then
a = frmSrchTotpr.txtTotpr
txtargTotpr.Text = a
Else
a = 30000
End If
