...
Begin VB.Form frmSrchAddr 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Search Customer by Address"
   ClientHeight    =   3690
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4680
   Icon            =   "frmSrchAddr.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3690
