...
Begin VB.Form frmResDesc 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Results of Search by Description"
   ClientHeight    =   4575
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5775
   Icon            =   "frmResDesc.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
...
lvwProducts.ListItems.Clear
    While Not rs.EOF
    If InStr(1, rs!Description, a) <> 0 Then
