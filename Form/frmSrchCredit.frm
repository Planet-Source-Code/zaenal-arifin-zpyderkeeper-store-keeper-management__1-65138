...
Begin VB.Form frmSrchCredit 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Search Customer by Credit"
   ClientHeight    =   3690
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4680
   Icon            =   "frmSrchCredit.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3690
   ...
   Begin prjChameleon.chameleonButton cmdCLose 
      ...
      FCOLO           =   0
      MPTR            =   0
      MICON           =   "frmSrchCredit.frx":0EE6
   End
   Begin VB.Frame Frame1 
      Caption         =   "Enter Minimum Credit Amount"
      Height          =   1575
      Left            =   120
      TabIndex        =   1
      Top             =   120
   ...
   End
End
Attribute VB_Name = "frmSrchCredit"
