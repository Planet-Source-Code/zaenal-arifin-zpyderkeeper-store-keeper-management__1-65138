...
Begin VB.Form frmResPhone 
   Caption         =   "Results of Search by Phone / Cell Number"
   ClientHeight    =   4545
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5775
   Icon            =   "frmResPhone.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
...
lvwContacts.ListItems.Clear
    While Not rs.EOF
    If a = rs!PhoneNo Or a = rs!Celno Then
