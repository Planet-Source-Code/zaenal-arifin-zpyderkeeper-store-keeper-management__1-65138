...
Begin VB.Form frmResCredit 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Results of Search by Credit Amount"
   ClientHeight    =   4575
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5790
   Icon            =   "frmResCredit.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdClose 
      ...
      FCOLO           =   0
      MPTR            =   0
      MICON           =   "frmResCredit.frx":0ECA
   End
   Begin VB.TextBox txtargCredit 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0FFFF&
      Height          =   285
      Left            =   120
   ...
   End
End
Attribute VB_Name = "frmResCredit"
...
If (frmSrchCredit.txtCredit <> "") Then
a = frmSrchCredit.txtCredit
txtargCredit.Text = a
Else
a = 30000
End If
