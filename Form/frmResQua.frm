...
Begin VB.Form frmResQua 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Results of Search by Quantity"
   ClientHeight    =   4590
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5790
   Icon            =   "frmResQua.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdClose 
      ...
      FCOLO           =   0
      MPTR            =   0
      MICON           =   "frmResQua.frx":0ECA
   End
   Begin VB.TextBox txtargQua 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0FFFF&
      Height          =   285
      Left            =   120
